...
// ============================================================
export const types = {
  LOAD_GOODS: 'boostHelp/LOAD',
  LOAD_GOODS_SUCCESS: 'boostHelp/SUCCESS',
  LOAD_CLEAR: 'boostHelp/CLEAR' //清空数据
};
...
export const actions = {
  ...
  // 加载商品数据
  loadDataAsync(tradeId, numIid, boosterId, avatarUrl) {
    return async dispatch => {
      dispatch(this.loadGoods());
      const res = await requestWithForm(URL.boosting, {
        tradeId,
        numIid,
        boosterId,
        avatarUrl
      });
      dispatch(this.loadGoodsSuccess(res.data));
    };
  }
};
