...
class ThemeList extends Component {
  ...
  componentDidMount() {
    ...
    const { title = '商品列表', banner, bgcolor = '#ffffff' } = this.$router.params;
    ...
    dispatch(themeListActions.loadThemeListTbAsync('2', '116'));
  }
        ...
        <View className='theme-list'>
          ...
          <View className='goods-list' style={{ backgroundColor: bgcolor }}>
            <GoodsList
              ...
              union='tb'
              onClick={goods => {
                jumpUrl(`/pages/details/details?id=${goods.id}`);
              }}
            />
          </View>
        </View>
