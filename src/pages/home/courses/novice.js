            ...
            {currentTab === 'pdd' ? (
              <View className='course-pdd'>
                <Image
                  className='img'
                  mode='widthFix'
                  src='https://h5.suixingou.com/miniprogram-assets/sxgqq/qq/courses-s1.png'
                />
                <Image
                  className='img'
                  mode='widthFix'
                  src='https://h5.suixingou.com/miniprogram-assets/sxgqq/qq/courses-s2-new.png'
                />
                <Image
                  className='img'
                  mode='widthFix'
                  src='https://h5.suixingou.com/miniprogram-assets/sxgqq/qq/courses-s3.png'
                />
              </View>
            ) : (
